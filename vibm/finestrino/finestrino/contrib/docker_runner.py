...
from finestrino.local_target import LocalFileSystem
...
class DockerTask( finestrino.Task ):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.mount_tmp:
            ...
            self._host_tmp_dir = mkdtemp(suffix=self.task_id,
                                         prefix='finestrino-docker-tmp-dir-',
                                         dir='/tmp')
        ...
        self.environment['FINESTRINO_TMP_DIR'] = self.container_tmp_dir
