...
class FollowExternalServer(BaseJob):
    ...
    def prepare(self):
        ...
        self.configurator = Configurator( self.toml_parser ) 
        
    def start(self):
        print( "***** New External-Server(s) Following Patrol ... %s , %s *****" % (datetime.datetime.now, self.configurator.external_monitoring.vlab) )
